...
import { addProdut, editProduct, getAllProducts, getSingleProduct, resetState } from '../../features/product/ProductSlice';
...
const EditProduct = () => {
  ...
  const { isLoading, isSuccess, isError, productEdited, singleProduct } = useSelector((state) => state.product);
  ...
  if (singleProduct) {
    setFormData({
      ...
      banner: singleProduct.banner || false,
    });
  ...
  }, [isSuccess, isError, productEdited, dispatch]);
  ...
  return (
    <AdminLayout>
      ...
      >
        <h2 className="text-3xl font-semibold mb-8 text-center text-gray-700">Update Product</h2>
